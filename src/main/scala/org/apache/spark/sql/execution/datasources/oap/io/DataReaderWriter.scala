...
private[oap] abstract class DataReaderWriter(val cardinal: Int) {
...
private[oap] class BoolDataReaderWriter(ordinal: Int) extends DataReaderWriter(ordinal) {
...
private[oap] class ByteDataReaderWriter(ordinal: Int) extends DataReaderWriter(ordinal) {
  protected[this] def writeInternal(out: FSDataOutputStream, row: InternalRow): Unit = {
...
private[oap] class ShortDataReaderWriter(ordinal: Int) extends DataReaderWriter(ordinal) {
  protected[this] def writeInternal(out: FSDataOutputStream, row: InternalRow): Unit = {
...
private[oap] class IntDataReaderWriter(ordinal: Int) extends DataReaderWriter(ordinal) {
  protected[this] def writeInternal(out: FSDataOutputStream, row: InternalRow): Unit = {
...
private[oap] class LongDataReaderWriter(ordinal: Int) extends DataReaderWriter(ordinal) {
  protected[this] def writeInternal(out: FSDataOutputStream, row: InternalRow): Unit = {
...
private[oap] class FloatDataReaderWriter(ordinal: Int) extends DataReaderWriter(ordinal) {
  protected[this] def writeInternal(out: FSDataOutputStream, row: InternalRow): Unit = {
...
private[oap] class DoubleDataReaderWriter(ordinal: Int) extends DataReaderWriter(ordinal) {
  protected[this] def writeInternal(out: FSDataOutputStream, row: InternalRow): Unit = {
...
private[oap] class DateDataReaderWriter(ordinal: Int) extends DataReaderWriter(ordinal) {
  protected[this] def writeInternal(out: FSDataOutputStream, row: InternalRow): Unit = {
    out.writeInt(row.getInt(ordinal))
  }
...
private[oap] class TimestampDataReaderWriter(ordinal: Int) extends DataReaderWriter(ordinal) {
  protected[this] def writeInternal(out: FSDataOutputStream, row: InternalRow): Unit = {
    out.writeLong(row.getLong(ordinal))
  }
...
private[oap] class StringDataReaderWriter(cardinal: Int) extends DataReaderWriter(cardinal) {
  protected[this] def writeInternal(out: FSDataOutputStream, row: InternalRow): Unit = {
