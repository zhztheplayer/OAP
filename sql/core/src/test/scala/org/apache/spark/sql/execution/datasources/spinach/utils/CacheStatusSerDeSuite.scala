...
class CacheStatusSerDeSuite extends SparkFunSuite {
  ...
  test("test data file meta") {
    val dataFileMeta = new DataFileMeta(new ArrayBuffer[RowGroupMeta](), 3, 2, 3, 3)
  ...
  private def assertDataFileMetaEquals(dataFileMeta1: DataFileMeta, dataFileMeta2: DataFileMeta) {
