...
class BenchmarkArrowComputeBigScale : public ::testing::Test {
 public:
  void SetUp() override {
...
TEST_F(BenchmarkArrowComputeBigScale, AggregateBenchmark) {
...
TEST_F(BenchmarkArrowComputeBigScale, GroupByAggregateBenchmark) {
  // prepare expression
...
TEST_F(BenchmarkArrowComputeBigScale, GroupByWithTwoAggregateBenchmark) {
  // prepare expression
  std::vector<std::shared_ptr<::gandiva::Node>> field_node_list;
  for (auto field : field_list) {
    field_node_list.push_back(TreeExprBuilder::MakeField(field));
...
/*TEST_F(BenchmarkArrowComputeBigScale, SortBenchmark) {
  // prepare expression
  std::vector<std::shared_ptr<::gandiva::Node>> field_node_list;
  for (auto field : field_list) {
    field_node_list.push_back(TreeExprBuilder::MakeField(field));
