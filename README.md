...
```
## Prerequisites
You should have [Apache Spark](http://spark.apache.org/) of version 2.2.0 installed in your cluster. Refer to Apache Spark's [documents](http://spark.apache.org/docs/2.2.0/) for details.
## Use OAP with Spark
